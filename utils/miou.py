...
LABELS = ['background', 'hat', 'hair', 'sunglasses', 'upper-clothes', 'skirt', 'pants', \
          'dress', 'belt', 'left-shoe', 'right-shoe', 'face', 'left-leg', 'right-leg', 'left-arm', 'right-arm',
          'bag', 'scarf']


# LABELS = ['Background', 'Head', 'Torso', 'Upper Arms', 'Lower Arms', 'Upper Legs', 'Lower Legs']

def get_palette(num_cls = 18):
...
def compute_mean_ioU(preds, scales, centers, num_classes, datadir, input_size=[512, 512], dataset='val'):
